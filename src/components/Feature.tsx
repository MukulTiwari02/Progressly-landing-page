...
export const Feature = ({ feature }: { feature: any }) => {
  ...
  return (
    <div className="border sm:flex-1 border-white/30 px-5 py-10 text-center rounded-xl relative">
      <motion.div
        ref={border}
        style={{
          maskImage: maskImage,
        ...
        className="absolute border-2 inset-0 border-purple-400 rounded-xl"
      ></motion.div>
      <div className="inline-flex rounded-lg h-14 w-14 bg-white text-black justify-center items-center">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
